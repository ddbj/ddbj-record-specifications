...
| v3 フィールド | 対応する各形式の名称 |
|-------------|-------------------|
| submission.hold_date | BP: Hold/@release_date、SRA: `@target` の無い ACTION/HOLD の @HoldUntilDate（[v3-sra.md](./v3-sra.md#hold_date-と-actions-の-hold)）、GEA: IDF の Public Release Date と ADF の Comment[Public Release Date]、Trad: hold_date |
