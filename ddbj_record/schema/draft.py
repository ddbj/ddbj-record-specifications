...
class ApplicationIdentification(BaseModel):
    """
    Patent application identification information.
    This class represents the identification of a patent application, including the filing date,
    IP office code, and application number.
    """
    ...
    filing_date: str | None = Field(
        ...
        pattern=r"^\d{4}-\d{2}-\d{2}$",
        examples=["2024-01-15"],
        description="The filing date of the patent application (ISO 8601 format).",
    )
    ip_office_code: str = Field(
        ...,
        examples=["JP"],
        description="The code of the intellectual property office (e.g., JP, US, EP).",
    )
    application_number_text: str = Field(
        ...,
        examples=["2024-123456"],
        description="The application number text (e.g., YYYY-NNNNNN format).",
    )
...
class Submission(BaseModel):
    ...
    invention_title: str | None = Field(
        None,
        examples=["Method for producing modified organism"],
        description="The title of the patent invention (ST.26).",
    )
    publication_date: str | None = Field(
        None,
        pattern=r"^\d{4}-\d{2}-\d{2}$",
        examples=["2024-06-01"],
        description="The publication date of the patent (ISO 8601 format, ST.26).",
    )
    applicant_name: str | None = Field(
        None,
        examples=["Example Corporation"],
        description="The name of the patent applicant (ST.26).",
    )
    inventor_name: str | None = Field(
        None,
        examples=["Taro Yamada"],
        description="The name of the patent inventor (ST.26).",
    )
    application_identification: ApplicationIdentification | None = Field(
        None,
        description="Patent application identification information (ST.26).",
    )
    earliest_priority_application_identifications: list[ApplicationIdentification] | None = Field(
        None,
        description="List of earliest priority patent application identifications (ST.26).",
    )
...
class Source(BaseModel):
    ...
    tax_id: int | None = Field(
        None,
        examples=[1605],
        description="NCBI Taxonomy ID for the organism. Used for flatfile db_xref and taxonomy name resolution.",
    )
