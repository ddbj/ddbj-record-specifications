...
IDF = {
    ...
    "Person First Name": "investigation.persons[].first_name",
    "Person Last Name": "investigation.persons[].last_name",
    "Person Affiliation": "investigation.persons[].organizations[].name (その人の 1 つ目の organization)",
    "Person Roles": "investigation.persons[].role",
    ...
    "Public Release Date": "investigation.public_release_date",
    ...
    "Comment[Last Update Date]": "investigation.last_update_date",
...
ADF = {
    ...
    "Comment[Public Release Date]": "array_design.public_release_date",
